    ...
    <div class="modal-dialog" role="document">
      <div class="modal-content">
        <div class="modal-header">
          <h5 class="modal-title" id="modal-input-proktor-label">Assessment Baru</h5>
        ...
        <div class="modal-body">
          <div class="form-group">
            <label for="nip">Kode Proktor</label>
            <input type="email" class="form-control" id="nip" placeholder="Masukan Kode Proktor">
          </div>
        </div>
